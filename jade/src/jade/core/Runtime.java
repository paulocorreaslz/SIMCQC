...
public class Runtime {
	...
	public static String getVersion() {
		String version = "3.7"; // The $ surrounded Version keyword is automatically replaced by the target doTag of build.xml
		return version;
	}
	
	public static String getRevision() {
		String revision = "6154"; // The $ surrounded WCREV keyword is automatically replaced by WCREV with subversion
		return revision;
	}
	
	public static String getDate() {
		String date = "2009/07/01 17:34:15"; // The $ surrounded WCDATE keyword is automatically replaced by WCREV with subversion
		return date;
	}
}
